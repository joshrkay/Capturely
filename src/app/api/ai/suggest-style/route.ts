...
import { suggestStyle } from "@/lib/ai/claude";
...
/** POST /api/ai/suggest-style — AI style suggestions */
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await suggestStyle(parsed.data);
    ...
    return NextResponse.json({ style: result.content, tokensUsed: result.tokensUsed });
  } catch (err) {
